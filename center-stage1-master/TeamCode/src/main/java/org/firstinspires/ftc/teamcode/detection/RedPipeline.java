...
import org.firstinspires.ftc.teamcode.detection.RedDetection;
...
public class RedPipeline {
    ...
    LinearOpMode opMode;
    RedDetection cameraPipeline;
    OpenCvInternalCamera phoneCam;

    HardwareMap hardwareMap;

    public RedPipeline(LinearOpMode opMode, HardwareMap hwMap) {
        this.opMode = opMode;
        hardwareMap = hwMap;
    }
    public void initializeCamera() {
        ...
        cameraPipeline = new RedDetection();
